...
mixin DateConverter {
  ...
  static DateTime stringToLocalDate(String dateTime) {
    // print('DateTime.parse(dateTime) ${DateTime.parse(dateTime)}');
  ...
  static String isoStringToLocalFullDateOnlyVN(String dateTime) {
    return DateFormat('dd-MM-yyyy')
        .format(isoStringToLocalDate(dateTime).add(const Duration(hours: 7)));
  }
  ...
  static String isoStringToLocalDateHMSVN(String dateTime) {
    return DateFormat('HH:mm dd/MM/yyyy')
        .format(isoStringToLocalDate(dateTime).add(const Duration(hours: 7)));
  }
  ...
  static String isoStringToVNTimeDateOnly(String dateTime) {
    return DateFormat('HH:mm dd/MM/yyyy')
        .format(isoStringToLocalDate(dateTime));
  }
  ...
  static String formatDateTimeGlobal(String dateTime) {
    return DateConverter.isoStringToLocalFullDateOnly(
            dateTime.replaceAll("T", " ").substring(0, dateTime.length - 1))
        .toString();
  }

  static String formatDateTimeFullGlobal({required String dateTime}) {
  ...
  static String formatDateTime(String dateTime) {
    return DateConverter.isoStringToLocalFullDateOnlyVN(
            dateTime.replaceAll("T", " ").substring(0, dateTime.length - 1))
        .toString();
  }

  static String formatDateTimeFull({required String dateTime}) {
    return DateConverter.isoStringToLocalDateHMSVN(
            dateTime.replaceAll("T", " ").substring(0, dateTime.length - 1))
        .toString();
  }
