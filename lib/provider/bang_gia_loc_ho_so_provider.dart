...
class BangGiaLocHoSoProvider {
  ...
  ///
  Future<void> all({
    required Function(List<BangGiaLocHoSoResponse> bangGiaLocHoSos) onSuccess,
  ...
  ///
  Future<void> add({
    required BangGiaLocHoSoRequest data,
    required Function(BangGiaLocHoSoRequest bangGiaLocHoSo) onSuccess,
    required Function(dynamic error) onError,
  }) async {
  ...
  Future<void> find({
    required String id,
    required Function(BangGiaLocHoSoResponse bangGiaLocHoSo) onSuccess,
    required Function(dynamic error) onError,
  }) async {
