...
class NotificationProvider {
  ...
  ///
  Future<void> all({
    required Function(List<NotificationModel> notifications) onSuccess,
  ...
  Future<void> add({
    ...
    required Function(NotificationModel notifications) onSuccess,
    required Function(dynamic error) onError,
  }) async {
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(NotificationModel.fromJson(results as Map<String, dynamic>));
    } else {
      onError(apiResponse.error);
    }
  }
