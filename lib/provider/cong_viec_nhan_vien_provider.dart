...
class CongViecNhanVienProvider {
  ...
  ///
  Future<void> all({
    required Function(List<CongViecNhanVienModel> congViecNhanViens) onSuccess,
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(results
          .map((e) => CongViecNhanVienModel.fromJson(e as Map<String, dynamic>))
          .toList());
    } else {
  ...
  ///
  Future<void> add({
    required CongViecNhanVienModel data,
    required Function(CongViecNhanVienModel congViecNhanVien) onSuccess,
    required Function(dynamic error) onError,
  }) async {
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(CongViecNhanVienModel.fromJson(results as Map<String, dynamic>));
    } else {
      onError(apiResponse.error);
    }
  }
