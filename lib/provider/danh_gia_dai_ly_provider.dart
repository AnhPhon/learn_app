...
class DanhGiaDaiLyProvider {
  DanhGiaDaiLyRepository? repository = GetIt.I.get<DanhGiaDaiLyRepository>();

  DanhGiaDaiLyProvider();
  ...
  ///
  /// Delete danhGiaDaiLy to database
  ///
  Future<void> delete({
    required String id,
    required Function(DanhGiaDaiLyRequest danhGiaDaiLy) onSuccess,
  ...
  ///
  /// Get paginate danhGiaDaiLys "page": 1, "limit": 10
  ///
