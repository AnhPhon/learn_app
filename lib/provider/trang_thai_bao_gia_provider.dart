...
class TrangThaiBaoGiaProvider {
  ...
  ///
  Future<void> all({
    required Function(List<TrangThaiBaoGiaResponse> trangThaiBaoGias) onSuccess,
  ...
  ///
  Future<void> add({
    required TrangThaiBaoGiaRequest data,
    required Function(TrangThaiBaoGiaRequest trangThaiBaoGia) onSuccess,
    required Function(dynamic error) onError,
  }) async {
  ...
  Future<void> find({
    required String id,
    required Function(TrangThaiBaoGiaResponse trangThaiBaoGia) onSuccess,
    required Function(dynamic error) onError,
  }) async {
