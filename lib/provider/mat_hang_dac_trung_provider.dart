...
class MatHangDacTrungProvider {
  MatHangDacTrungRepository? repository =
      GetIt.I.get<MatHangDacTrungRepository>();
  ...
  Future<void> all({
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(results
          .map((e) =>
              MatHangDacTrungResponse.fromJson(e as Map<String, dynamic>))
          .toList());
    } else {
  ...
  Future<void> add({
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(
          MatHangDacTrungRequest.fromJson(results as Map<String, dynamic>));
    } else {
      onError(apiResponse.error);
    }
  }
  ...
  Future<void> find({
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      final results = apiResponse.response.data as dynamic;
      onSuccess(
          MatHangDacTrungResponse.fromJson(results as Map<String, dynamic>));
    } else {
      onError(apiResponse.error);
    }
  }
