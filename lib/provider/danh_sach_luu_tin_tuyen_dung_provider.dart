...
class DanhSachLuuTinTuyenDungProvider {
  DanhSachLuuTinTuyenDungRepository? repository =
      GetIt.I.get<DanhSachLuuTinTuyenDungRepository>();
  ...
  Future<void> all({
    required Function(
            List<DanhSachLuuTinTuyenDungResponse> danhSachLuuTinTuyenDungs)
        onSuccess,
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(results
          .map((e) => DanhSachLuuTinTuyenDungResponse.fromJson(
  ...
  Future<void> add({
    ...
    required Function(DanhSachLuuTinTuyenDungRequest danhSachLuuTinTuyenDung)
        onSuccess,
    required Function(dynamic error) onError,
  }) async {
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(DanhSachLuuTinTuyenDungRequest.fromJson(
  ...
  Future<void> find({
    required String id,
    required Function(DanhSachLuuTinTuyenDungResponse danhSachLuuTinTuyenDung)
        onSuccess,
    required Function(dynamic error) onError,
  }) async {
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      // call back data success
      final results = apiResponse.response.data as dynamic;
      onSuccess(DanhSachLuuTinTuyenDungResponse.fromJson(
          results as Map<String, dynamic>));
    } else {
      onError(apiResponse.error);
    }
