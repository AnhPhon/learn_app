...
class ThongBaoProvider {
  ...
  ///
  Future<void> all({
    required Function(List<ThongBaoModel> thongBaos) onSuccess,
  ...
  ///
  Future<void> add({
    required ThongBaoModel data,
    required Function(ThongBaoModel thongBao) onSuccess,
    required Function(dynamic error) onError,
  }) async {
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(ThongBaoModel.fromJson(results as Map<String, dynamic>));
    } else {
      onError(apiResponse.error);
    }
  }
