...
class ThuChiNhanVienProvider {
  ...
  ///
  Future<void> all({
    required Function(List<ThuChiNhanVienModel> thuChiNhanViens) onSuccess,
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(results
          .map((e) => ThuChiNhanVienModel.fromJson(e as Map<String, dynamic>))
          .toList());
    } else {
  ...
  ///
  Future<void> add({
    required ThuChiNhanVienModel data,
    required Function(ThuChiNhanVienModel thuChiNhanVien) onSuccess,
    required Function(dynamic error) onError,
  }) async {
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(ThuChiNhanVienModel.fromJson(results as Map<String, dynamic>));
    } else {
      onError(apiResponse.error);
    }
  }
