...
import 'package:template/data/model/body/loai_nhan_vien_model.dart';
...
class LoaiNhanVienProvider {
  ...
  ///
  Future<void> all({
    required Function(List<LoaiNhanVienModel> loaiNhanViens) onSuccess,
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(results
          .map((e) => LoaiNhanVienModel.fromJson(e as Map<String, dynamic>))
          .toList());
    } else {
  ...
  ///
  Future<void> add({
    required LoaiNhanVienModel data,
    required Function(LoaiNhanVienModel loaiNhanVien) onSuccess,
    required Function(dynamic error) onError,
  }) async {
    ...
    if (apiResponse.response.statusCode! >= 200 &&
      ...
      onSuccess(LoaiNhanVienModel.fromJson(results as Map<String, dynamic>));
    } else {
      onError(apiResponse.error);
    }
  }
