...
import 'package:template/data/model/response/hang_muc_xay_dung_response.dart';
...
class HangMucXayDungProvider {
  ...
  ///
  Future<void> all({
    required Function(List<HangMucXayDungResponse> hangMucXayDungs) onSuccess,
  ...
  ///
  Future<void> add({
    required HangMucXayDungRequest data,
    required Function(HangMucXayDungRequest hangMucXayDung) onSuccess,
    required Function(dynamic error) onError,
  }) async {
  ...
  Future<void> find({
    required String id,
    required Function(HangMucXayDungResponse hangMucXayDung) onSuccess,
    required Function(dynamic error) onError,
  }) async {
