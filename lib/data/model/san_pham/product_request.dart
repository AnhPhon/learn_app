...
class ProductRequest extends ProductResponse{
  String? idProductPortfolio;

  ProductRequest({
    this.idProductPortfolio,
  });
  ...
  ProductRequest.fromJson(Map<String, dynamic> json) {
    ...
    idProductPortfolio = !IZIValidate.nullOrEmpty(json['idProductPortfolio']) ? json['idProductPortfolio'].toString() : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (!IZIValidate.nullOrEmpty(idProductPortfolio)) data['idProductPortfolio'] = idProductPortfolio;
