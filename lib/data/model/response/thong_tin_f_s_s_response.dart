class ThongTinFSSResponse {
  ...
  String? hoTro;
  String? huongDanAnToanLaoDong;
  String? giayKhamSucKhoe;
  ...
  ThongTinFSSResponse(
      ...
      this.chiTietBaoHiem,
      this.hoTro,
      this.huongDanAnToanLaoDong,
      this.giayKhamSucKhoe,
      this.createdAt,
      this.updatedAt});
  ...
  ThongTinFSSResponse.fromJson(Map<String, dynamic> json) {
    ...
    gioiThieuTomTatCoCheHoatDong =
        json['gioiThieuTomTatCoCheHoatDong'].toString();
    ...
    huongDanAnToanLaoDong = json['huongDanAnToanLaoDong'].toString();
    giayKhamSucKhoe = json['giayKhamSucKhoe'].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    if (gioiThieuTomTatCoCheHoatDong != null)
    ...
    if (quyTrinhSuDungGiaoDich != null)
    ...
    // check null huongDanAnToanLaoDong
    if (huongDanAnToanLaoDong != null) data['huongDanAnToanLaoDong'] = huongDanAnToanLaoDong;

    // check null giayKhamSucKhoe
    if (giayKhamSucKhoe != null) data['giayKhamSucKhoe'] = giayKhamSucKhoe;
