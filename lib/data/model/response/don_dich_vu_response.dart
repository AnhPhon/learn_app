...
class DonDichVuResponse {
  ...
  LoaiCongTrinhResponse? idCongTrinh;
  ...
  TrangThaiThanhToanResponse? idTrangThaiThanhToanKhac;
  ...
  DonDichVuResponse.fromJson(Map<String, dynamic> json) {
    ...
    // print('Parse id loai cong viec');
    // print('Parse id loai cong viec ${json['idLoaiCongViec']}');
    if (json['idLoaiCongViec'] != null &&
        json['idLoaiCongViec'] != 'null' &&
    ...
    // mapping idTrangThaiThanhToanKhac
    if (json['idTrangThaiThanhToanKhac'] != null &&
        json['idTrangThaiThanhToanKhac'].toString().length != 24) {
      idTrangThaiThanhToanKhac = TrangThaiThanhToanResponse.fromJson(
          json['idTrangThaiThanhToanKhac'] as Map<String, dynamic>);
    } else {
      idTrangThaiThanhToanKhac = null;
    }
    ...
    // print('Parse tinh tanh pho don dich vu ${json['idTinhTp']}');
    ...
    if (json['idThongSoKyThuats'] != null &&
        (json['idThongSoKyThuats'] as List<dynamic>).isNotEmpty &&
    ...
    if (json['idCongTrinh'] != null &&
        json['idCongTrinh'].toString().length != 24) {
      idCongTrinh = LoaiCongTrinhResponse.fromJson(
          json['idCongTrinh'] as Map<String, dynamic>);
    } else {
      idCongTrinh = null;
    }
    tienDoGiaoHang = json['tienDoGiaoHang'] != null
        ? json['tienDoGiaoHang'] as String
        : null;

    phiDichVuKhac = json['phiDichVuKhac'].toString();
    tienCocKhac = json['tienCocKhac'].toString();
    khuyenMaiKhac = json['khuyenMaiKhac'].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    // check null phiDichVuKhac
    if (phiDichVuKhac != null) data['phiDichVuKhac'] = ngayKetThuc;

    // check null tienCocKhac
    if (tienCocKhac != null) data['tienCocKhac'] = ngayKetThuc;

    // check null khuyenMaiKhac
    if (khuyenMaiKhac != null) data['khuyenMaiKhac'] = ngayKetThuc;
    ...
    // check null idTrangThaiThanhToanKhac
