...
class TaiKhoanResponse {
  ...
  TaiKhoanResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['idNhomCuaHang'] != null && json['idNhomCuaHang'].toString().length!=24) {                                                  
      idNhomCuaHang = NhomCuaHangResponse.fromJson(json['idNhomCuaHang'] as Map<String, dynamic>); 
    } else {                                                                           
      idNhomCuaHang = null;                                                               
    }                                                                                  

    // mapping idMatHangDacTrung                                                              
    if (json['idMatHangDacTrung'] != null && json['idMatHangDacTrung'].toString().length!=24) {                                                  
      idMatHangDacTrung = MatHangDacTrungResponse.fromJson(json['idMatHangDacTrung'] as Map<String, dynamic>); 
    } else {                                                                           
