...
class TuyenDungResponse {
  ...
  String? createdAt;
  String? updatedAt;
  List<LoaiCongViecResponse>? idChuyenNganhPhus;
  ...
  TuyenDungResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['idLoaiCongViec'] != null &&
      ...
      idChuyenNganhChinh = LoaiCongViecResponse.fromJson(
    ...
    // mapping idTinhTp
    if (json['idNoiLamViecs'] != null &&
        json['idNoiLamViecs'].toString().length != 24) {
      idNoiLamViecs =
          (json['idNoiLamViecs'] as List<dynamic>).map((e) => TinhTpResponse.fromJson(e as Map<String, dynamic>)).toList();
    } else {
      idNoiLamViecs = null;
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (idChuyenNganhChinh != null) data['idLoaiCongViec'] = idChuyenNganhChinh;
    ...
    // check null idNoiLamViecs
    if (idNoiLamViecs != null) data['idNoiLamViecs'] = idNoiLamViecs;
    ...
    if (idChuyenNganhPhus != null) data['idChuyenNganhPhus'] = idChuyenNganhPhus;
    ...
    if (idTrangThaiTuyenDung != null) data['idTrangThaiTuyenDung'] = idTrangThaiTuyenDung;
