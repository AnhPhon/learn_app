...
class DangKyViecMoiResponse {
  ...
  DangKyViecMoiResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['idLoaiNhanVien'] != null && json['idLoaiNhanVien'].toString().length!=24) {                                                  
      idLoaiNhanVien = LoaiNhanVienResponse.fromJson(json['idLoaiNhanVien'] as Map<String, dynamic>); 
    } else {                                                                           
      idLoaiNhanVien = null;                                                               
    }                                                                                  
    ...
    if (json['idBangBangCap'] != null && json['idBangBangCap'].toString().length!=24) {                                                  
      idBangBangCap = BangBangCapResponse.fromJson(json['idBangBangCap'] as Map<String, dynamic>); 
    } else {                                                                           
      idBangBangCap = null;                                                               
    }                                                                                  
    ...
    if (json['idKeKhaiKinhNghiem'] != null && json['idKeKhaiKinhNghiem'].toString().length!=24) {                                                  
      idKeKhaiKinhNghiem = KeKhaiKinhNghiemResponse.fromJson(json['idKeKhaiKinhNghiem'] as Map<String, dynamic>); 
    } else {                                                                           
    ...
    // mapping idNgoaiNgu                                                              
    if (json['idNgoaiNgu'] != null && json['idNgoaiNgu'].toString().length!=24) {                                                  
      idNgoaiNgu = NgoaiNguResponse.fromJson(json['idNgoaiNgu'] as Map<String, dynamic>); 
    } else {                                                                           
      idNgoaiNgu = null;                                                               
    }                                                                                  
    ...
    if (json['idTinHoc'] != null && json['idTinHoc'].toString().length!=24) {                                                  
      idTinHoc = TinHocResponse.fromJson(json['idTinHoc'] as Map<String, dynamic>); 
    } else {                                                                           
      idTinHoc = null;                                                               
    }                                                                                  
