...
class PreviewServiceRequest {
  ...
  String? idTaiKhoan;
  String? idNhomDichVu;
  LoaiCongTrinhResponse? idLoaiCongTrinh;
  String? tieuDe;
  String? moTa;
  String? ngayBatDau;
  String? ngayKetThuc;
  List<ChiTietCongViecResponse>? bangKhoiLuongCongViec;
  List<ChiTietVatTuResponse>? chiTietVatTus;
  ...
  PreviewServiceRequest.fromJson(Map<String, dynamic> json) {
    ...
    idLoaiCongViec = (json['idLoaiCongViec'] == null) ? null : json['idLoaiCongViec'].toString();
  }
