...
class DonDichVuRequest {
  ...
  String? idTrangThaiThanhToanKhac;
  ...
  String? tienCoc;
  String? tienCocKhac;
  String? phiDichVuKhac;
  String? khuyenMaiKhac;
  String? donVi;
  String? diaChiCuThe;
  String? idLoaiCongViec;
  String? idTaiKhoanNhanDon;
  bool? updateTrangThaiThanhToanKhac;
  ...
  DonDichVuRequest(
      ...
      this.updateTrangThaiThanhToanKhac,
      this.diaChiCuThe});
  ...
  DonDichVuRequest.fromJson(Map<String, dynamic> json) {
    ...
    if (json['idCongTrinh'] != null) idCongTrinh = json['idCongTrinh'].toString();
    if (json['tienDoGiaoHang'] != null) tienDoGiaoHang = json['tienDoGiaoHang'].toString();
    ...
    if (json['idTrangThaiThanhToanKhac'] != null) idTrangThaiThanhToanKhac = json['idTrangThaiThanhToanKhac'].toString();
    if (json['updateTrangThaiThanhToanKhac'] != null) updateTrangThaiThanhToanKhac = json['updateTrangThaiThanhToanKhac'] as bool;
    ...
    if (json['idCongTrinh'] != null) {
      idCongTrinh = json['idCongTrinh'].toString();
    }
    if (json['tienDoGiaoHang'] != null) {
      tienDoGiaoHang = json['tienDoGiaoHang'].toString();
    }
    if (json['tieuDe'] != null) tieuDe = json['tieuDe'].toString();
    if (json['moTa'] != null) moTa = json['moTa'].toString();
    if (json['ngayBatDau'] != null) ngayBatDau = json['ngayBatDau'].toString();
    ...
    if (json['tienCocKhac'] != null) tienCocKhac = json['tienCocKhac'].toString();
    if (json['phiDichVuKhac'] != null) phiDichVuKhac = json['phiDichVuKhac'].toString();
    if (json['khuyenMaiKhac'] != null) khuyenMaiKhac = json['khuyenMaiKhac'].toString();
    if (json['donVi'] != null) donVi = json['donVi'].toString();

    if (json['diaChiCuThe'] != null) {
  ...
  Map<String, dynamic> toJson() {
    ...
    // Loại công trình
    if (idCongTrinh != null) data['idCongTrinh'] = idCongTrinh;
    // Tiến độ giao hàng
    if (tienDoGiaoHang != null) data['tienDoGiaoHang'] = tienDoGiaoHang;
    ...
    // check null idTrangThaiThanhToan
    if (idTrangThaiThanhToanKhac != null) {
      data['idTrangThaiThanhToanKhac'] = idTrangThaiThanhToanKhac;
    }
    ...
    if (tienCocKhac != null) data['tienCocKhac'] = tienCocKhac;
    if (phiDichVuKhac != null) data['phiDichVuKhac'] = phiDichVuKhac;
    if (khuyenMaiKhac != null) data['khuyenMaiKhac'] = khuyenMaiKhac;
    // check null donVi
    ...
    print('model request idLoaiCongViec $idLoaiCongViec');
    // print('model request giaTriKhachDeXuat $giaTriKhachDeXuat');
