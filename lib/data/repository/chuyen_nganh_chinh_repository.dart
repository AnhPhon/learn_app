...
class ChuyenNganhChinhRepository {
  ...
  ///
  Future<ApiResponse> add(ChuyenNganhChinhRequest data) async {
    try {
  ...
  ///
  Future<ApiResponse> update(ChuyenNganhChinhRequest data) async {
    try {
  ...
  Future<ApiResponse> delete(String id) async {
    try {
      final response =
          await dioClient!.delete('/chuyen-nganh-chinhs/$id');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
