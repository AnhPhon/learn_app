...
class BangGiaDonHangRepository {
  ...
  ///
  Future<ApiResponse> add(BangGiaDonHangRequest data) async {
    try {
  ...
  ///
  Future<ApiResponse> update(BangGiaDonHangRequest data) async {
    try {
  ...
  Future<ApiResponse> delete(String id) async {
    try {
      final response =
          await dioClient!.delete('/bang-gia-don-hangs/$id');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
