...
class BangBangCapRepository {
  ...
  ///
  Future<ApiResponse> add(BangBangCapModel data) async {
    try {
  ...
  ///
  Future<ApiResponse> update(BangBangCapModel data) async {
    try {
  ...
  /// Update bang-bang-cap to database
  ///
  Future<ApiResponse> delete(String id, BangBangCapModel data) async {
    try {
      final response =
          await dioClient!.delete('/bang-bang-caps/$id', data: data.toJson());
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
