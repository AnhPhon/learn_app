...
class DanhSachBaoGiaDonDichVuRepository {
  ...
  ///
  Future<ApiResponse> add(DanhSachBaoGiaDonDichVuRequest data) async {
    try {
      final response = await dioClient!
          .post('/danh-sach-bao-gia-don-dich-vus', data: data.toJson());
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  ///
  Future<ApiResponse> update(DanhSachBaoGiaDonDichVuRequest data) async {
    try {
      final response = await dioClient!
          .put('/danh-sach-bao-gia-don-dich-vus', data: data.toJson());
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> delete(String id) async {
    try {
      final response =
          await dioClient!.delete('/danh-sach-bao-gia-don-dich-vus/$id');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> paginate(int page, int limit, String filter) async {
    try {
      String uri =
          '/danh-sach-bao-gia-don-dich-vus/paginate?page=$page&limit=$limit'
              .toString();

      // add condition filter
      if (filter != '') {
        uri =
            '/danh-sach-bao-gia-don-dich-vus/paginate?page=$page&limit=$limit$filter';
      }
