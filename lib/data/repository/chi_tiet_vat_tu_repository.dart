...
class ChiTietVatTuRepository {
  ...
  ///
  Future<ApiResponse> add(ChiTietVatTuModel data) async {
    try {
  ...
  ///
  Future<ApiResponse> update(ChiTietVatTuModel data) async {
    try {
  ...
  /// Update chi-tiet-vat-tu to database
  ///
  Future<ApiResponse> delete(String id, ChiTietVatTuModel data) async {
    try {
      final response =
          await dioClient!.delete('/chi-tiet-vat-tus/$id', data: data.toJson());
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
