...
import 'package:template/view/screen/payment/payment_account/payment_account_page.dart';
...
import 'package:template/view/screen/product/cart/cart_page.dart';
import 'package:template/view/screen/product/product_detail/product_detail_page.dart';
import 'package:template/view/screen/product/product_page.dart';
import 'package:template/view/screen/product/shipping_address/shipping_address_page.dart';
import 'package:template/view/screen/product/shipping_method/shipping_method_page.dart';
...
import 'package:template/view/screen/v1-customer/services/g7-recruitment/show_list_candidates/show_list_candidates_page.dart';
...
import 'package:template/view/screen/v1-customer/services/vat_lieu_xay_dung/preview_vat_tu/preview_vat_tu_page.dart';
import 'package:template/view/screen/v1-customer/services/vat_lieu_xay_dung/vat_lieu_xay_dung_page.dart';
...
import 'package:template/view/screen/v2-builder/account/my_order/my_order_page.dart';
import 'package:template/view/screen/v2-builder/account/my_order/order_detail/order_detail_page.dart';
...
import 'package:template/view/screen/v2-builder/account/profile/accident_insurance/accident_insurance_page.dart';
...
import 'package:template/view/screen/v2-builder/payment_order/payment_order_page.dart';
...
import 'package:template/view/screen/v2-builder/shorthanded_group3/winning_bid/winning_bid_page.dart';
...
import 'package:template/view/screen/v3-agent/account/customer_management/customer_detail/customer_detail_page.dart';
...
import 'package:template/view/screen/v3-agent/account/profile/accident_insurance/accident_insurance_page.dart';
...
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/chua_phan_hoi/chua_phan_hoi_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/chua_phan_hoi/chua_phan_hoi_page.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/da_phan_hoi/da_phan_hoi_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/da_phan_hoi/da_phan_hoi_page.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/ket_qua_bao_gia/ket_qua_bao_gia_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/ket_qua_bao_gia/ket_qua_bao_gia_page.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/quote_phan_hoi_bao_gia_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/quote_phan_hoi_bao_gia_page.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/tai_khoan_cua_ban/tai_khoan_cua_ban_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/tai_khoan_cua_ban/tai_khoan_cua_ban_page.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/thanh_toan_phi_dich_vu/thanh_toan_phi_dich_vu_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/thanh_toan_phi_dich_vu/thanh_toan_phi_dich_vu_page.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/thong_bao_thanh_cong/thong_bao_thanh_cong_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/thong_bao_thanh_cong/thong_bao_thanh_cong_page.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/thong_tin_khach_hang/thong_tin_khach_hang_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/thong_tin_khach_hang/thong_tin_khach_hang_page.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/thong_tin_thanh_toan/thong_tin_thanh_toan_binding.dart';
import 'package:template/view/screen/v3-agent/danh_sach_phan_hoi_bao_gia/thong_tin_thanh_toan/thong_tin_thanh_toan_page.dart';
...
import 'package:template/view/screen/wallet/before_recharge/before_recharge_page.dart';
import 'package:template/view/screen/wallet/wallet_page.dart';
...
class AppPages {
  static List<GetPage> list = [
    ...
    GetPage(
      name: AppRoutes.SHIPPING_METHOD,
      page: () => ShippingMethodPage(),
    ),
    GetPage(
    ...
    GetPage(
      name: AppRoutes.V1_BAO_GIA_VAT_LIEU_XAY_DUNG,
      page: () => V1VatLieuXayDungPage(),
    ),
    GetPage(
      name: AppRoutes.V1_PREVIEW_VAT_TU,
      page: () => const V1PreviewVatTuPage(),
    ),
    ...
    GetPage(
      name: AppRoutes.V1_SHOW_LIST_CANDICATE,
      page: () => ShowListCandicatePage(),
    ),
    ...
    GetPage(
      name: AppRoutes.BEFORE_RECHARGE,
      page: () => BeforeRechargePage(),
    ),
    ...
    // GetPage(
    //     name: AppRoutes.V2_3_FORMAL_PAYMENT,
    //     page: () => V2_3FormalPaymentPage(),
    //     binding: V2_3FormalPaymentBinding()),
    // Hình thức thanh toán
    GetPage(
    ...
    GetPage(
      name: AppRoutes.V2_MY_ORDER,
      page: () => V2MyOrderPage(),
    ),
    GetPage(
      name: AppRoutes.V2_ORDER_DETAIL,
      page: () => V2OrderDetailPage(),
    ),
    ...
    GetPage(
      name: AppRoutes.V3_CHUA_PHAN_HOI,
      page: () => V3ChuaPhanHoiPage(),
      binding: V3ChuaPhanHoiBinding(),
    ),
    GetPage(
      name: AppRoutes.V3_DA_PHAN_HOI,
      page: () => V3DaPhanHoiPage(),
      binding: V3DaPhanHoiBinding(),
    ),
    GetPage(
      name: AppRoutes.V3_KET_QUA_BAO_GIA,
      page: () => V3KetQuaBaoGiaPage(),
      binding: V3KetQuaBaoGiaBinding(),
    ),
    GetPage(
      name: AppRoutes.V3_TAI_KHOAN_CUA_BAN,
      page: () => V3TaiKhoanCuaBanPage(),
      binding: V3TaiKhoanCuaBanBinding(),
    ),
    GetPage(
      name: AppRoutes.V3_THANH_TOAN_PHI_DICH_VU,
      page: () => V3ThanhToanPhiDichVuPage(),
      binding: V3ThanhToanPhiDichVuBinding(),
    ),
    GetPage(
      name: AppRoutes.V3_THONG_TIN_KHACH_HANG,
      page: () => V3ThongTinKhachHangPage(),
      binding: V3ThongTinKhachHangBinding(),
    ),
    GetPage(
      name: AppRoutes.V3_THONG_TIN_THANH_TOAN,
      page: () => V3ThongTinThanhToanPage(),
      binding: V3ThongTinThanhToanBinding(),
    ),
    GetPage(
      name: AppRoutes.V3_THONG_BAO_THANH_CONG,
      page: () => V3ThongBaoThanhCongPage(),
      binding: V3ThongBaoThanhCongBinding(),
    ),
    GetPage(
    ...
    GetPage(
      name: AppRoutes.V2_WORK_IN_DONE,
      page: () => V2WorkInDonePage(),
      binding: V2WorkInDoneBinding(),
    ),
    GetPage(
