class AppRoutes {
  ...
  //
  static const String V1_BAO_GIA_VAT_LIEU_XAY_DUNG =
      "/v1_bao_gia_vat_lieu_xay_dung";
  ...
  static const String V1_SHOW_LIST_CANDICATE = '/v1_show_list_candicate';
  ...
  // Vật tư
  static const String V1_PREVIEW_VAT_TU = "/v1_preview_vat_tu";
  // Thành công
  static const String V1_SUCCESSFULLY = "/v1_successfully";

  // Hình thức thanh toán
  static const String V1_FORMAL_PAYMENT = "/v1_formal_payment";
  static const String V2_3_FORMAL_PAYMENT = "/v2_3_formal_payment";
  //
  ...
  static const String BEFORE_RECHARGE = '/before_recharge';
  ...
  static const String V2_MY_ORDER = "/v2_my_order";
  static const String V2_ORDER_DETAIL = "/v2_order_detail";
  ...
  static const String V3_CHUA_PHAN_HOI = '/v3_chua_phan_hoi';
  static const String V3_DA_PHAN_HOI = '/v3_da_phan_hoi';
  static const String V3_THONG_BAO_THANH_CONG = '/v3_thong_bao_thanh_cong';
  ...
  static const String V3_KET_QUA_BAO_GIA = '/v3_ket_qua_bao_gia';
  static const String V3_TAI_KHOAN_CUA_BAN = '/v3_tai_khoan_cua_ban';
  static const String V3_THANH_TOAN_PHI_DICH_VU = '/v3_thanh_toan_phi_dich_vu';
  static const String V3_THONG_TIN_KHACH_HANG = '/v3_thong_tin_khach_hang';
  static const String V3_THONG_TIN_THANH_TOAN = '/v3_thong_tin_thanh_toan';
  ...
  static const String V2_WORK_IN_DONE = '/v2_work_in_done';
