...
class SharedPreferenceHelper {
  ...
  // phản hồi đơn dịch vụ: ----------------------------------------------------------
  Future<String?> get idPhanHoiDonDichVu async {
    return _sharedPreference.getString(Preferences.idPhanHoiDonDichVu);
  }

  Future<bool> saveIdPhanHoiDonDichVu(String id) async {
    return _sharedPreference.setString(Preferences.idPhanHoiDonDichVu, id);
  }

  Future<bool> removeIdPhanHoiDonDichVu() async {
    return _sharedPreference.remove(Preferences.idPhanHoiDonDichVu);
  }
