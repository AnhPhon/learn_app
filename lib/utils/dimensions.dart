...
class Dimensions {
  static const double FONT_SIZE_EXTRA_SMALL_SMALL = 5.0;
  ...
  static const double FONT_SIZE_OVER_LARGE_LARGE = 24.0;
  static const double FONT_SIZE_OVER_LARGE_LARGE_LARGE = 26.0;
  ...
  Widget paddingDivider(BuildContext context, {Color? color, double? height}) {
    return Padding(
