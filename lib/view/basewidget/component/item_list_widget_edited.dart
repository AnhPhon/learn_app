...
class ItemListWidgetEdited extends StatelessWidget {
                      ...
                      children: [
                        ...
                        if (icon2 != null || rowText2 != null)
                          Expanded(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.end,
                              mainAxisAlignment: (isSpaceBetween == true) ? MainAxisAlignment.end : MainAxisAlignment.start,
                              children: [
                                if (icon2 != null) icon2!,
                                if (icon2 != null && rowText2 != null)
                                  const SizedBox(
