...
class CreateWorkPage extends GetView<CreateWorkController> {
  ...
  Widget workGroup(BuildContext context,
      {required CreateWorkController controller}) {
    return Column(
      children: [
        DropDownButton<NhomDichVuResponse>(
          data: controller.nhomDichVuResponseList,
          obligatory: true,
        ...
        SearchDropDownButton<LoaiCongViecResponse?>(
          ...
          obligatory: true,
          onChanged: (value) =>
              value != null ? controller.onChangedLoaiCongViec(value) : null,
          value: controller.loaiCongViec,
          width: DeviceUtils.getScaledSize(context, 1),
          label: "Chọn công việc phù hợp",
          hint: 'Chọn công việc',
          isSort: controller.dichvu!.id != NHOM_DICH_VU_1,
        ...
        DefaultTextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              onSelectedWorkLocation(context,
            ...
            children: [
              ...
              if (isTinhKhac)
                SearchDropDownButton<PhuongXaResponse>(
                  obligatory: false,
                  isHideLineButton: true,
                  isEnable: groupValue == 3 && ward.isNotEmpty,
