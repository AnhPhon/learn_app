...
class V1G4CreateServicePage extends GetView<V1G4CreateServiceController> {
  final V1G4CreateServiceController _controller =
      Get.find<V1G4CreateServiceController>();
    ...
    return Column(
      children: [
              ...
              builder: (V1G4CreateServiceController controller) {
                return Row(
                  children: [
                    RadioButton<GENDER>(
                        title: "Nam",
                        onChanged: (val) => controller.onChangedGender(val!),
                        value: GENDER.Nam,
        ...
        TextFieldDate(
          ...
          fontSize: Dimensions.FONT_SIZE_LARGE,
          holdplacer: "Vui lòng chọn ngày bắt đầu",
          label: "Ngày bắt đầu",
          obligatory: true,
          typeInput: TextInputType.text,
          width: DeviceUtils.getScaledWidth(context, 1),
        ...
        TextFieldDate(
          ...
          fontSize: Dimensions.FONT_SIZE_LARGE,
          holdplacer: "Vui lòng chọn ngày kết thúc",
          label: "Ngày kết thúc",
          obligatory: false,
          typeInput: TextInputType.text,
          width: DeviceUtils.getScaledWidth(context, 1),
