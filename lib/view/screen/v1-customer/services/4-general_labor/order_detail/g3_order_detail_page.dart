        ...
        children:  [
          ...
          Padding(
            ...
            child: BillWidget(
              ...
              orderContents: [
              OrderContentStringValue(title:"Gội đầu tại nhà" , value:"${CurrencyConverter.currencyConverterVND(300000)} VNĐ/công", boldValue: true,),
              ...
              OrderContentStringValue(title:"Phí dịch vụ App" , value:"${CurrencyConverter.currencyConverterVND(8000)} VNĐ", boldValue: true,),
              OrderContentStringValue(title:"Khuyến mãi của App" , value:"${CurrencyConverter.currencyConverterVND(5000)} VNĐ", boldValue: true,),
              OrderContentStringValue(title:"Tổng tiền đơn hàng" , value:"${CurrencyConverter.currencyConverterVND(455000)} VNĐ", boldValue: true,),
            ]),
          ),
