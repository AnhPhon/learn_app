...
class V1G2CreateWorkPage extends GetView<V1G2CreateWorkController> {
  final V1G2CreateWorkController _controller =
      Get.find<V1G2CreateWorkController>();
    ...
    return Column(
      children: [
        ...
        InputField(
          ...
          fontSize: Dimensions.FONT_SIZE_LARGE,
          holdplacer: "Mô tả khối lượng công việc của bạn",
          hidden: false,
    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: Text(
              "(Những công việc mang tính chất cải tạo cần nhiều hình ảnh chi tiết, cụ thể, rõ ràng để báo giá sát nhất,...)"),
        ),
        Padding(
          ...
          child: BoxImage(
              ...
              isAddImage: true,
              onPress: () =>
                  controller.pickImages(data: controller.currentStatusimages),
  ...
  Widget attchFile(BuildContext context,
      {required V1G2CreateWorkController controller}) {
    return Column(
      children: [
        const Label(
          label: "Đính kèm file excel hoặc khác (nếu có)",
          obligatory: false,
        ),
        AttachButton(
          title: controller.donDichVuFiles.isEmpty
              ? "Thêm tập tin"
              : controller.donDichVuFiles.first,
