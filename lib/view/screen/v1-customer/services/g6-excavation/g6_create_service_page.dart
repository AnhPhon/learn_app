      ...
      children: [
       ...
       // Bề rộng mặt đường làm việc
        ...
        InputField(
          ...
          fontSize: Dimensions.FONT_SIZE_LARGE,
          holdplacer: "Vd: Diện tích móng (DxR);Móng đơn/bằng 1/2 phương bằng 2 phương;Độ sâu của móng;Đất chở đi hay để lại 1 bên; Có đắp đất lại không ?;Đào 1 lần hay 2 lần?.../Nội dung khác",
          hidden: false,
