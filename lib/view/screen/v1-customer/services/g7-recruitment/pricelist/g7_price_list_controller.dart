...
class V1G7PriceListController extends GetxController {
  ...
  void onClickContinueButton() {
    ...
    //Đã truyền nội dung thanh toán
    Get.toNamed(
            '${AppRoutes.ORDER_INFORMATION}?soTien=${tuyenDungRequest.soTien!}&tienCoc=${tuyenDungRequest.tienCoc}&isTuyenDung=true&noiDung=Thanh toán đăng tin tuyển dụng')!
        .then((value) => {
              //đã thanh toán
