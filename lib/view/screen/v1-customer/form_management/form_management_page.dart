                  ...
                  itemBuilder: (BuildContext ctx, int index) {
                    return Padding(
                      ...
                      child: ItemListWidget(
                        textOverImage: true,
                        stringTextOverImage:
                            controller.donDichVuList[index].idTinhTp != null
                            ? controller.donDichVuList[index].idTinhTp!.ten
                            : null,
                        title:
                        ...
                        urlImage: controller
                            .donDichVuList[index].idNhomDichVu!.hinhAnhDaiDien,
                        rowText1: controller.donDichVuList[index].idQuanHuyen ==
                                null
                            ? null
                            : controller.donDichVuList[index].idQuanHuyen!.ten
                                .toString(),
                        icon1: controller.donDichVuList[index].idQuanHuyen ==
                                null
                            ? null
                            : const Icon(
                          Icons.location_on,
