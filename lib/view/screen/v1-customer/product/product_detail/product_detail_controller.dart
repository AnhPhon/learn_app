...
class V1ProductDetailController extends GetxController {
  ...
  Future<void> getTaiKhoan() async {
    ...
    taiKhoanProvider.find(
      ...
      onError: (error) {
        print("V1ProductDetailController getTaiKhoan onError $error");
      },
    );
  }
  ...
  void getDonHang() {
    ...
    donHangProvider.paginate(
      ...
      onError: (error) {
        print("V1ProductDetailController getDonHang onError $error");
      },
    );
  }
  ...
  void getChiTietDonHang({required String idDonHang}) {
    chiTietDonHangProvider.paginate(
      ...
      onError: (error) {
        print("V1ProductDetailController getChiTietDonHang onError $error");
      },
    );
  }
    ...
    if (donHangResponse != null) {
      ...
      if (index != -1) {
        ...
        chiTietDonHangProvider.update(
          ...
          onError: (error) {
            print(
                "V1ProductDetailController chiTietDonHangUpdate onError $error");
          },
        );
      } else {
        ...
        chiTietDonHangProvider.add(
          ...
          onError: (error) {
            print("V1ProductDetailController chiTietDonHangAdd onError $error");
          },
        );
      }
    } else {
      ...
      donHangProvider.add(
        ...
        onSuccess: (donHangAdd) {
          ...
          chiTietDonHangProvider.add(
            ...
            onError: (error) {
              print(
                  "V1ProductDetailController chiTietDonHangAdd onError $error");
            },
          );
        },
        onError: (error) {
  ...
  void onCartClick() {
    ...
    Get.toNamed(AppRoutes.V1_CART, arguments: donHang)!.then(
      (value) {
