...
class V1ProjectController extends GetxController with SingleGetTickerProviderMixin {
  ...
  Future<void> getListDuAnKhachHang(int indexOfTab) async {
    ...
    await duAnKhachHangProvider.paginate(
      ...
      onSuccess: (data) {
        ...
        if(data.isEmpty){
          valueGlobalNotifier.changeSmartRefreshNoDataStatus('GetXSmartRefreshPageV1Project_$indexOfTab', true);
        } else {
          valueGlobalNotifier.changeSmartRefreshNoDataStatus('GetXSmartRefreshPageV1Project_$indexOfTab', false);
        }
  ...
  Future<void> getListLoadMoreDuAnKhachHang(int indexOfTab) async {
    ...
    await duAnKhachHangProvider.paginate(
      ...
      onError: (error) {
        print('V1ProjectController getListLoadMoreDuAnKhachHang $error');
      },
    );
  }
  ...
  ///
  /// Dinh dang output ngay thang nam
  ///
