...
class V1JobManagementPage extends GetView<V1JobManagementController> {
  ...
  /// tab
  ///
  Widget _tabBarWidget({required BuildContext context, required V1JobManagementController controller}) {
    return Container(
                        ...
                        itemBuilder: (BuildContext ctx, int index) {
                          return Padding(
                            ...
                            child: ItemListWidget(
                              ...
                              icon1: controller.donDichVuList[index].idQuanHuyen == null ? null : const Icon(
                                Icons.location_on,
