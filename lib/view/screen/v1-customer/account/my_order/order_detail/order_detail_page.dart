...
import 'package:template/view/screen/v1-customer/account/my_order/order_detail/order_detail_controller.dart';

class V1OrderDetailPage extends GetView<V1OrderDetailController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<V1OrderDetailController>(
        init: V1OrderDetailController(),
        builder: (controller) {
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (controller.checkProduct() == true)
                    Column(
                      children: [
                        //product info
                        const Label(
  ...
  Widget _thongTinChung(
      BuildContext context, V1OrderDetailController controller) {
        ...
        children: [
          ...
          rowText(
            ...
            text2: DateConverter.formatDateTimeFull(
              dateTime: controller.donHangResponse.updatedAt.toString(),
            ),
          ),
          Dimensions().paddingDivider(context),
          rowText(
  ...
  ///shipping
  ///
  Widget _shipping(BuildContext context, V1OrderDetailController controller) {
    return BoxShadowWidget(
      padding: const EdgeInsets.all(
        Dimensions.PADDING_SIZE_DEFAULT,
      ),
