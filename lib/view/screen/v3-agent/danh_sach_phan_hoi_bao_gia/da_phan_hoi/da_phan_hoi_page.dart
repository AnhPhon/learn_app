...
class V3DaPhanHoiPage extends GetView<V3DaPhanHoiController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarWidget(title: controller.title),
      body: GetBuilder<V3DaPhanHoiController>(
        init: V3DaPhanHoiController(),
        builder: (V3DaPhanHoiController controller) {
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  // Hinh Anh Khoi Luong
                  LongButton(
                    title: "Đề nghị thanh toán phí",
                    color: ColorResources.THEME_DEFAULT,
                    onPressed: () {
                      controller.onThanhToanPhiDichVuClick();
                    },
                  ),
                  const SizedBox(height: Dimensions.MARGIN_SIZE_SMALL),
                ],
                ...
                child: Column(
                  children: infoCard.isEmpty
                      ...
                      : List.generate(
                          ...
                          (jndex) {
                            print(infoCard[index][jndex].length);
                            final String label =
