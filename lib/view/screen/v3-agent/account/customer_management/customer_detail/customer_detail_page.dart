                        ...
                        itemBuilder: (BuildContext ctx, int index) {
                          return Padding(
                            ...
                            child: ItemListWidget(
                              textOverImage: controller.currentIndex == 0,
                              stringTextOverImage: controller.currentIndex != 0
                                  ? ''
                                  : controller.donDichVuList[index].idTinhTp !=
                                          null
                                      ? controller
                                          .donDichVuList[index].idTinhTp!.ten
                                      : '',
                              ...
                              onTap: () {},
                              isSpaceBetween: true,
                              urlImage: controller.donDichVuList.first
