    ...
    baoHiemProvider.paginate(
      ...
      onSuccess: (value) {
        if (value.isNotEmpty) {
          ...
          //generate list
          isChecked = List<bool>.generate(baoHiemResponse.length, (_) => false);
        }
        isLoading = false;
        update();
      },
      onError: (error) {
        print("V3OtherInsuranceController getInsurance onError $error");
      },
    );
  }
      ...
      for (var i = 0; i < isChecked!.length; i++) {
        ...
        if (isChecked![i] == true) {
          ...
          dangKyBaoHiemProvider.add(
            ...
            onSuccess: (value) {},
            onError: (error) {
              print("V3OtherInsuranceController dangKyMuaBtn onError $error");
            },
          );
        }
