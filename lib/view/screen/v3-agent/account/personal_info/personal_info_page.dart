...
import 'package:template/view/screen/v3-agent/account/personal_info/personal_info_controller.dart';

class V3PersonalInfoPage extends GetView<V3PersonalInfoController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<V3PersonalInfoController>(
        init: V3PersonalInfoController(),
        builder: (controller) {
  ...
  Widget _avatar(BuildContext context,
      {required V3PersonalInfoController controller}) {
    return Stack(
      children: [
        //image
        Container(
