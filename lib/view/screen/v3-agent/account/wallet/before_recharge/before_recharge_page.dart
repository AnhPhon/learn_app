...
import 'package:template/view/screen/v3-agent/account/wallet/before_recharge/before_recharge_controller.dart';

class V3BeforeRechargePage extends GetView<V3BeforeRechargeController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<V3BeforeRechargeController>(
        init: V3BeforeRechargeController(),
        builder: (controller) {
          return Scaffold(
  ...
  Widget _accountBalance(BuildContext context,
      {required V3BeforeRechargeController controller}) {
    return Padding(
