...
class V3DashboardPage extends StatelessWidget {
  final V3DashboardController v3DashboardController = V3DashboardController();
        ...
        return Builder(
          builder: (context) {
            return WillPopScope(
              ...
              child: Scaffold(
                body: IndexedStack(
                  index: v3DashboardController.tabIndex,
                  children: [
                    V3HomePage(v3DashboardController: v3DashboardController),
                    V3ProjectPage(),
                    V3EntertainmentPage(),
                    V3NewsPage(),
                    V3AccountPage(),
                ...
                bottomNavigationBar: BottomNavigationBar(
                  ...
                  onTap: v3DashboardController.changeTabIndex,
