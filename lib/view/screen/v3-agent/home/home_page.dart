...
class V3HomePage extends GetView<V3HomeController> {
  V3DashboardController? v3DashboardController;

  V3HomePage({this.v3DashboardController});
  ...
  Widget _newsWidget() {
    ...
    return FieldWidget(
      ...
      onTap: () {
        controller.onClickHotNews(v3DashboardController!);
      },
      widget: Column(
  ...
  Widget _productWidget(BuildContext context) {
    ...
    // backup
    return FieldWidget(
      title: "Kho sản phẩm".toUpperCase(),
      onTap: () {
            ...
            child: GestureDetector(
              ...
              child: KhoSanPham(
                onTap: () {
                  // call detail
                  controller.onClickHotProductDetail(
                      controller.sanPhamList[index].id.toString());
                },
                title: controller.sanPhamList[index].ten!,
                rowText1: "Mã: ${controller.sanPhamList[index].maSanPham}",
                rowText2: "${PriceConverter.convertPrice(
                  context,
                  double.parse(controller.sanPhamList[index].gia!),
                )} VND",
                rowText3: "Quy cách: ",
                rowText4: controller.sanPhamList[index].quyCach,
                colorRowText1: ColorResources.BLACKGREY,
                colorRowText2: ColorResources.BLACKGREY,
                isStart: true,
                urlImage:
