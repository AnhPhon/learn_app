...
class V3NewsCategoriesPage extends StatefulWidget {
  final DanhMucTinTucResponse danhMucTinTucList;

  const V3NewsCategoriesPage({Key? key, required this.danhMucTinTucList})
      : super(key: key);

  @override
  _V3NewsCategoriesPageState createState() => _V3NewsCategoriesPageState();
}

class _V3NewsCategoriesPageState extends State<V3NewsCategoriesPage>
    with AutomaticKeepAliveClientMixin {
  V3NewsCategoriesController? controller;
  ...
  void initState() {
    ...
    super.initState();
    controller =
        Get.put(V3NewsCategoriesController(), tag: widget.key.toString());
