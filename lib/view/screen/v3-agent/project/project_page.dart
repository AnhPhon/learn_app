...
class V3ProjectPage extends GetView<V3ProjectController> {
  ...
  /// tab bar button
  ///
  Widget _tabBarWidget({required BuildContext context, required V3ProjectController controller}) {
    return Container(
                  ...
                  children: List.generate(
                    ...
                    (index) {
                      return GetXSmartRefreshPage(
                        key: Key('GetXSmartRefreshPageV3Project_$index'),
                        enablePullUp: true,
                        enablePullDown: true,
