...
import 'package:template/view/screen/v4-employee/notifications/notifications_controller.dart';

class V4NotificationPage extends GetView<NotificationController> {
  @override
