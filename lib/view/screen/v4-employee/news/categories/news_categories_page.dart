...
class V4NewsCategoriesPage extends StatefulWidget {
  final DanhMucTinTucResponse danhMucTinTucList;

  const V4NewsCategoriesPage({Key? key, required this.danhMucTinTucList})
      : super(key: key);

  @override
  _V4NewsCategoriesPageState createState() => _V4NewsCategoriesPageState();
}

class _V4NewsCategoriesPageState extends State<V4NewsCategoriesPage>
    with AutomaticKeepAliveClientMixin {
  V4NewsCategoriesController? controller;
  ...
  void initState() {
    ...
    super.initState();
    controller =
        Get.put(V4NewsCategoriesController(), tag: widget.key.toString());
