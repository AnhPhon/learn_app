...
import 'package:template/view/screen/v4-employee/news/new_detail/news_detail_controller.dart';

class V4NewsDetailPage extends GetView<V4NewsDetailController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<V4NewsDetailController>(
        init: V4NewsDetailController(),
        builder: (controller) {
  ...
  ///title news
  ///
  Widget _titleNews({required V4NewsDetailController controller}) {
    return Padding(
  ...
  Widget _author(BuildContext context,
      {required V4NewsDetailController controller}) {
    return Flexible(
      child: Text(
  ...
  ///view and time
  ///
  Widget _views({required V4NewsDetailController controller}) {
  ...
  ///content
  ///
  Widget _content({required V4NewsDetailController controller}) {
