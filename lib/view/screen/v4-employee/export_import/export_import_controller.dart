...
class V4ExportImportControleer extends GetxController {
  ...
  //Khai báo Dự án Nhân viên Provider
...
//khi báo isLoading
  ...
  final exportController = TextEditingController(text: "Xuất kho");
  final importController = TextEditingController(text: "Nhập kho");
  ...
  ///
  /// Load kho hàng theo id dự án nhân viên
  ///
