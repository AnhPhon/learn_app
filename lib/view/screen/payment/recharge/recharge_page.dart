...
class RechargePage extends GetView<RechargeController> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    _textTitle(
                      context,
                      title: "Vui lòng lựa chọn tài khoản giao dịch",
                    ),
                      ...
                      children: [
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) => Card(
                            elevation: 2,
                            margin: const EdgeInsets.all(Dimensions.MARGIN_SIZE_SMALL),
                            child: ListTile(
                                leading: Radio(
                                  value: index,
                                ...
                                title: Text(controller.thongTinNganHangResponse[index].soTaiKhoan.toString()),
                                subtitle: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [Text(controller.thongTinNganHangResponse[index].tenNganHang.toString()), Text(controller.thongTinNganHangResponse[index].tenChuTaiKhoan.toString())],
                                ),
                                trailing: IconButton(onPressed: () => {controller.onChangeRadio(index), controller.onBtnCopyClick(content: controller.thongTinNganHangResponse[index].soTaiKhoan.toString())}, icon: const Icon(Icons.copy, color: ColorResources.GREEN))),
                          ),
                        ),
                      ],
                    ),
                    ...
                    Padding(
                      ...
                      child: DefaultTextStyle(
                        style: const TextStyle(fontWeight: FontWeight.w600, fontSize: Dimensions.FONT_SIZE_LARGE, color: ColorResources.BLACK),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text('Số tiền tối thiểu', textAlign: TextAlign.center),
                            const SizedBox(
                              height: Dimensions.MARGIN_SIZE_SMALL,
                            ),
                            Text(
                                ...
                                style: const TextStyle(color: ColorResources.RED)),
                          ],
                        ),
                      ),
                    ), //bank info
                    ...
                    //title upload
                    _textTitle(context, title: "Tải hình ảnh hoá đơn giao dịch"),
  ...
  ///row 3 widget
  ///
  // Widget _row3Widget(BuildContext context, {required String text1, required String text2, required Icon icon, required VoidCallback onTap}) {
  //   return Padding(
  //     padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL, vertical: Dimensions.PADDING_SIZE_EXTRA_SMALL),
  //     child: DefaultTextStyle(
  //       style: const TextStyle(
  ...
  ///content
  ///
  Widget _content(BuildContext context, {required RechargeController controller}) {
    return Container(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () => controller.onBtnCopyClick(content: "FSS-${controller.taiKhoanResponse.soDienThoai}"),
                child: const Icon(
                  Icons.copy_outlined,
