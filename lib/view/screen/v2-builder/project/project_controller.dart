...
class V2ProjectController extends GetxController with SingleGetTickerProviderMixin {
  ...
  Future<void> getListDuAnKhachHang(int indexOfTab) async {
    ...
    await duAnKhachHangProvider.paginate(
      ...
      onSuccess: (data) {
        ...
        if(data.isEmpty){
          valueGlobalNotifier.changeSmartRefreshNoDataStatus('GetXSmartRefreshPageV2Project_$indexOfTab', true);
        } else {
          valueGlobalNotifier.changeSmartRefreshNoDataStatus('GetXSmartRefreshPageV2Project_$indexOfTab', false);
        }
  ...
  Future<void> getListLoadMoreDuAnKhachHang(int indexOfTab) async {
    ...
    await duAnKhachHangProvider.paginate(
      ...
      onError: (error) {
        print('V1ProjectController loadMoreNews $error');
      },
    );
  }
