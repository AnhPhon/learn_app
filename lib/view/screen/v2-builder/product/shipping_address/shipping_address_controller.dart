...
class V2ShippingAddressController extends GetxController {
  ...
  void getTinhTp({bool? isFisrt = false}) {
    ...
    tinhTpProvider.all(
      ...
      onError: (error) {
        print("V2ProductDetailController getTinhTp onError $error");
      },
    );
  }
  ...
  void getQuanHuyen({required String idTinhTp, bool? isFisrt = false}) {
    ...
    quanHuyenProvider.paginate(
      ...
      onError: (error) {
        print("V2ProductDetailController getQuanHuyen onError $error");
      },
    );
  }
  ...
  void updateAddress(BuildContext context) {
    ...
    if (tinhTpResponse == null) {
      ...
      donHangProvider.update(
        ...
        onError: (error) {
          print("V2ShippingAddressController updateAddress onError $error");
        },
      );
    }
  }
