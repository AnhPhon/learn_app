...
import 'package:template/view/screen/v2-builder/account/personal_info/personal_info_controller.dart';

class V2PersonalInfoPage extends GetView<V2PersonalInfoController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<V2PersonalInfoController>(
        init: V2PersonalInfoController(),
        builder: (controller) {
  ...
  Widget _avatar(BuildContext context,
      {required V2PersonalInfoController controller}) {
    return Stack(
      children: [
        //image
        Container(
