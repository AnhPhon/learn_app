...
class V2PersonalInfoController extends GetxController {
  ...
  void getAccounInfomation() {
    sl.get<SharedPreferenceHelper>().userId.then((userId) {
      ...
      taiKhoanProvider.find(
        ...
        onError: (error) {
          print("V2PersonalInfoController getAccounInfomation onError $error");
        },
      );
    });
  }
  ...
  void uploadImage({required List<File> image}) {
    imageUpdateProvider.addImages(
      ...
      onError: (error) {
        print("V2PersonalInfoController uploadImage onError $error");
      },
    );
  }
  ...
  void updateAccount(BuildContext context) {
    ...
    if (nameCompanyController.text.isEmpty) {
      ...
      taiKhoanProvider.update(
        ...
        onError: (error) {
          EasyLoading.dismiss();
          print("V2PersonalInfoController updateAccount onError $error");
        },
      );
    }
  }
