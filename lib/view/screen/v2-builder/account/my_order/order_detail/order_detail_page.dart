...
import 'package:template/view/screen/v2-builder/account/my_order/order_detail/order_detail_controller.dart';

class V2OrderDetailPage extends GetView<V2OrderDetailController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<V2OrderDetailController>(
        init: V2OrderDetailController(),
        builder: (controller) {
  ...
  Widget _thongTinChung(
      BuildContext context, V2OrderDetailController controller) {
  ...
  ///shipping
  ///
  Widget _shipping(BuildContext context, V2OrderDetailController controller) {
    return BoxShadowWidget(
      padding: const EdgeInsets.all(
        Dimensions.PADDING_SIZE_DEFAULT,
      ),
