...
import 'package:template/view/screen/v2-builder/account/mail/mail_controller.dart';

class V2MailPage extends GetView<V2MailController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<V2MailController>(
      init: V2MailController(),
      builder: (controller) {
