              ...
              children: const [
                Padding(
                  ...
                  child: TextHighlight(
                      title: "Tiêu đề: ",
                      content:
                          "Cần tuyển 02 kiến trúc sư làm việc tại Đà Nẵng"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Công ty:",
                      content: "Công ty TNHH Five Start Building System"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Địa chỉ:",
                      content:
                          "Thôn Trung Đông - Xã Trung Đông - Huyện Trung Đông - Tỉnh Trung Đông"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child:
                      TextHighlight(title: "Số lượng tuyển: ", content: "02"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      ...
                      content: "Nhân viên chính thức"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Trình độ học vấn:", content: "Đại học"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                ...
                Padding(
                  ...
                  child: TextHighlight(
                      ...
                      content: "Xây dựng DD&CN;Xây dựng cầu đường"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Số năm kinh nghiệm: ", content: "3 năm"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Mức lương ban đầu dự kiến:", content: "7 triệu"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child:
                      TextHighlight(title: "Nơi làm việc:", content: "Đà Nẵng"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Thời gian thử việc:", content: "1 tháng"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Hạn nộp hết ngày: ", content: "12/11/2021"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Tên: ", content: "Đoàn Thị Minh Duyên"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Số điện thoại:", content: "0934322343"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Địa chỉ:",
                      content: "51 Tô Hữu, Hải Châu, Thành Phố Đà Nẵng"),
                ),
                Padding(
                  padding:
                      EdgeInsets.only(top: Dimensions.PADDING_SIZE_DEFAULT),
                  child: TextHighlight(
                      title: "Email:", content: "tuyendung5sao@gmail.com"),
                ),
              ],
            ),
          ),
  ...
  Widget button() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SmallButton(
              title: "Lưu", color: ColorResources.GREY, onPressed: () {}),
          SmallButton(
              title: "Ứng tuyển",
