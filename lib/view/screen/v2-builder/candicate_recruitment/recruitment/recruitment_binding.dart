...
import 'search_recruitment_controller.dart';

class V2RecruitmentBinding extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<V2RecruitmentController>(() => V2RecruitmentController());
    Get.lazyPut<V2SearchRecruitmentController>(
        () => V2SearchRecruitmentController());
    Get.lazyPut<V2HistoryRecruitmentNewsController>(
        () => V2HistoryRecruitmentNewsController());
  }
}
