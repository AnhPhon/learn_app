...
import 'package:template/view/screen/v2-builder/candicate_recruitment/form_of_submission/cv/preview/components/candicate_card.dart';
    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: TextHighlight(title:"", content: "Được làm việc trong môi trường chuyên nghiệp, có chế độ tốt.Nâng cao được trình độ, kỹ năng chuyên môn Cống hiến năng lực bản thân và mong có cơ hội thăng tiến"),
        ),
        ...
        customButton(title: "File", verticalPadding: Dimensions.PADDING_SIZE_DEFAULT,onTap: (){})
      ],
    );
  }


  Widget customButton({required String title, double? verticalPadding, required Function onTap}){
