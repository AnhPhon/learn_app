...
class CapitalContributionConfirmationPage extends GetView<CapitalContributionConfirmationController> {
  @override
  Widget build(BuildContext context) {
    return IZIScreen(
      ...
      body: GetBuilder(
        builder: (CapitalContributionConfirmationController controller) {
          return Column(
  ...
  Widget customer(BuildContext context, {required CapitalContributionConfirmationController controller}) {
    return Container(
  ...
  Widget authorizedPerson(BuildContext context, {required CapitalContributionConfirmationController controller}) {
    return Container(
      margin: EdgeInsets.only(
        top: IZIDimensions.SPACE_SIZE_4X,
  ...
  Widget contractInformation(BuildContext context, {required CapitalContributionConfirmationController controller}) {
    return Container(
      margin: EdgeInsets.only(
        top: IZIDimensions.SPACE_SIZE_4X,
        left: IZIDimensions.SPACE_SIZE_4X,
  ...
  Widget contractPeriod(BuildContext context, {required CapitalContributionConfirmationController controller}) {
    return Container(
      margin: EdgeInsets.only(
        top: IZIDimensions.SPACE_SIZE_4X,
        left: IZIDimensions.SPACE_SIZE_4X,
  ...
  Widget reciprocal(BuildContext context, {required CapitalContributionConfirmationController controller}) {
    return Container(
      margin: EdgeInsets.only(
        top: IZIDimensions.SPACE_SIZE_4X,
        left: IZIDimensions.SPACE_SIZE_4X,
  ...
  Widget signature(BuildContext context, {required CapitalContributionConfirmationController controller}) {
    return Container(
      margin: EdgeInsets.only(
        top: IZIDimensions.SPACE_SIZE_4X,
        left: IZIDimensions.SPACE_SIZE_4X,
  ...
  // Ký tên
  Widget sign(BuildContext context, {required CapitalContributionConfirmationController controller}) {
    return Container(
  ...
  Widget button(CapitalContributionConfirmationController controller) {
    return IZIButton(
      margin: EdgeInsets.symmetric(
        horizontal: IZIDimensions.SPACE_SIZE_4X,
        vertical: IZIDimensions.SPACE_SIZE_2X,
