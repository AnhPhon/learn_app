...
import 'data/repository/chi_tiet_cong_viec_repository.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => DonViRepository());
  ...
  sl.registerLazySingleton(() => LoaiCongTrinhRepository());
  sl.registerLazySingleton(() => LienHeRiengRepository());
  sl.registerLazySingleton(() => ChiTietGiaThamKhaoRepository());
  sl.registerLazySingleton(() => YeuCauBaoHanhRepository());
  sl.registerLazySingleton(() => BangGiaChiTietThamKhaoRepository());
  ...
  sl.registerLazySingleton(() => ChiTietGiaThamKhaoProvider());
  sl.registerLazySingleton(() => ThongTinThueProvider());
  sl.registerLazySingleton(() => BaoHiemProvider());
  sl.registerLazySingleton(() => LoaiCongTrinhProvider());
  sl.registerLazySingleton(() => LienHeRiengProvider());
  sl.registerLazySingleton(() => YeuCauBaoHanhProvider());
  sl.registerLazySingleton(() => DonViProvider());
  sl.registerLazySingleton(() => BangGiaChiTietThamKhaoProvider());
}
